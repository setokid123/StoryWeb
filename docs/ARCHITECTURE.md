...
M2/U4 đã thêm cấu hình admin bật/tắt và chọn một trong hai phương thức mở khóa: nhấp liên kết hoặc xem quảng cáo có thưởng. Quyền đọc hết hạn sau 5 phút; các block quảng cáo hiển thị độc lập với quyền mở chương. U5/M3 bổ sung giao diện trang đọc, tùy chỉnh font/bố cục lưu trên thiết bị và hướng dẫn test link `example.com` trên DB riêng. Production hiện giữ luồng link tắt và rewarded chưa có provider web xác minh được. Xem [contract hiện hành](UNLOCK_API.md), [hướng dẫn test](UNLOCK_TEST_GUIDE.md) và [review I3](reviews/I3_READER_MCP_REVIEW_2026-09-24.md).
