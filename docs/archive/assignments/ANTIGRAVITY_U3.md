...
4. **Hoàn thiện thiết kế theo yêu cầu mới:** sửa font tiếng Việt và làm hai theme Sáng/Tối cho toàn site theo `docs/assignments/ANTIGRAVITY_U3_THEME_FONT.md`. Yêu cầu bổ sung này thay cho giới hạn “chỉ đổi thiết kế nơi cần thiết” trước đây. Giữ nhịp đọc yên tĩnh, không đổi hợp đồng props/API hoặc thêm thư viện UI nếu chưa phối hợp.
