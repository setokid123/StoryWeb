...
Quy tắc và phân công nằm tại [AGENTS.md](AGENTS.md), [CLAUDE.md](CLAUDE.md), [.agents/rules/project-context.md](.agents/rules/project-context.md) và [docs/WORKBOARD.md](docs/WORKBOARD.md). [Kế hoạch nút đọc, quảng cáo và hai cách mở khóa](docs/ADS_UNLOCK_PLAN.md) là đợt tiếp theo; [file giao việc cho Claude Code và Antigravity](docs/assignments/README.md) có đường dẫn worktree và câu nhắc để đưa cho từng app. Claude Code code toàn bộ logic, Antigravity code giao diện, Codex review/tích hợp; mỗi agent tự cập nhật bảng công việc khi nhận phần việc.
